...
DASHBOARD_RESULTS_DIR = PROJECT_ROOT / "dashboard_results"
...
AVAILABLE_MODELS = [
    ...
    {"id": "qwen-flash-2025-07-28", "label": "Qwen-Flash"},
    ...
    try:
        ...
        try:
            for suite_name in suites:
                ...
                # ---- 构建 Pipeline ----
                if is_origin:
                    pipeline, main_tracker = make_qwen_original_pipeline(
                        model_id, ad_defense=defense
                    ) if defense else make_qwen_original_pipeline(model_id)
                    sec_tracker = None
                else:
                    pipeline, main_tracker, sec_tracker = make_qwen_newFrame_pipeline(
                ...
                if sec_model_id and sec_tracker and use_security_checker:
